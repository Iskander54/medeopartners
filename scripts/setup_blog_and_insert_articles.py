#!/usr/bin/env python3
"""
Script complet pour créer les tables du blog et insérer les articles SEO
"""
...
def setup_blog_and_insert_articles():
    """Crée les tables du blog et insère les articles"""
    ...
    with app.app_context():
        ...
        print("📦 Étape 1 : Création des tables de la base de données...")
        try:
            db.create_all()
            print("✅ Tables créées avec succès !\n")
        except Exception as e:
            print(f"⚠️  Erreur lors de la création des tables : {e}")
            print("   Les tables existent peut-être déjà. Continuons...\n")
        
        # Étape 2 : Créer les catégories
        print("📁 Étape 2 : Création des catégories...")
        categories_map = {
        ...
        # Étape 3 : Récupérer un utilisateur pour l'auteur
        print("\n👤 Étape 3 : Recherche d'un auteur...")
        ...
        if not author:
            ...
            print(f"✅ Auteur trouvé : {author.email}\n")
        
        # Étape 4 : Créer les articles
        print("📝 Étape 4 : Création des articles SEO...")
        articles_created = 0
        articles_skipped = 0
        ...
        for article_data in ARTICLES:
            ...
            category = created_categories.get(article_data["category_slug"])
            if not category:
        ...
        print(f"⚠️  Articles ignorés (déjà existants) : {articles_skipped}")
        print(f"📁 Catégories disponibles : {len(created_categories)}")
        print()
...
if __name__ == "__main__":
    setup_blog_and_insert_articles()
